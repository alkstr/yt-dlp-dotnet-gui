...
namespace YTDLP.Dotnet.GUI.Models
{
    public partial class WebMediaFile : ObservableObject
    {
        ...
        [
            new Format(YouTube.Download.Format.Best,          Resources.BestQuality_ComboBox_Item),
            new Format(YouTube.Download.Format.BestAudioOnly, Resources.BestQualityAudioOnly_ComboBox_Item),
        ];
        public static HashSet<Subtitles> SubtitlesSet { get; } =
        [
            new Subtitles(YouTube.Download.Subtitles.None,     Resources.NoSubtitles_ComboBox_Item),
            new Subtitles(YouTube.Download.Subtitles.Embedded, Resources.EmbeddedSubtitles_ComboBox_Item),
            new Subtitles(YouTube.Download.Subtitles.File,     Resources.FileSubtitles_ComboBox_Item),
        ];
